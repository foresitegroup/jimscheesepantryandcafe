...
class gg_Featureddish_Widget extends WP_Widget {

	/*--------------------------------------------------*/
	/* CONSTRUCT THE WIDGET
	/*--------------------------------------------------*/

	function gg_Featureddish_Widget() {
  
	/* Widget name and description */
	$widget_opts = array (
		'classname' => 'gg_featureddish_widget', 
		'description' => __('Display a featured dish', 'gxg_textdomain')
	);	

	$this->WP_Widget('gg-featureddish-widget', __('LEMONCHILI - Featured Dish', 'gxg_textdomain'), $widget_opts);
...
add_action('widgets_init', create_function('', 'register_widget("gg_Featureddish_Widget");'));
?>