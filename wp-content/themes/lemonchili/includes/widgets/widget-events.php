...
class gg_Events_Widget extends WP_Widget {
	...
	$this->WP_Widget('gg-events-widget', __('LEMONCHILI - Events', 'gxg_textdomain'), $widget_opts);
...
add_action('widgets_init', create_function('', 'register_widget("gg_Events_Widget");'));
?>