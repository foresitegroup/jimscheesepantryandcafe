...
class gg_Hours_Widget extends WP_Widget {

	/*--------------------------------------------------*/
	/* CONSTRUCT THE WIDGET
	/*--------------------------------------------------*/

	function gg_Hours_Widget() {
  
	/* Widget name and description */
	$widget_opts = array (
		'classname' => 'gg_Hours_widget', 
		'description' => __('Display the opening hours', 'gxg_textdomain')
	);	
	
	$this->WP_Widget('gg_hours_widget', __('LEMONCHILI - Opening Hours', 'gxg_textdomain'), $widget_opts);
...
add_action('widgets_init', create_function('', 'register_widget("gg_Hours_Widget");'));
?>