...
//------------------------------------------------------------------------------
        ...
        $options[] = array( "name" => __('Configure the general setup of your theme. Upload a Logo, add some custom CSS and insert a google tracking code.','gxg_textdomain'),
        "type" => "info");
...
// LOGIN LOGO
        ...
        $options[] = array( "name" => __('Upload Logo for Login page','gxg_textdomain'),
                                                "desc" => __('Upload a Logo to replace the Wordpress Logo on the Login page','gxg_textdomain'),
                                                "id" => $shortname."_login_image",
                                                "type" => "upload");
                                                
        $options[] = array( "name" => __('Login Logo Height','gxg_textdomain'),
                                                "desc" => "Enter the height of your Login Logo. If your Logo has a height of 100px, enter: 100.",
                                                "id" => $shortname."_login_height",
                                                "std" => "",
                                                "type" => "text");
...
//------------------------------------------------------------------------------
        ...
        $options[] = array( "name" => __('Background Image','gxg_textdomain'),
                                                "desc" => __('Upload your own custom background image.','gxg_textdomain'),
